...
var packageName='/com.musala.database.web.spa.parser';
var viewName='/index.html#initialization';	
...
describe('angularjs homepage', function() {
	  ...
	  it('should redirect to this', function() {
		  ...
		  browser.sleep(1000);// absolutelly neccessery for triggering the next page
	  });
